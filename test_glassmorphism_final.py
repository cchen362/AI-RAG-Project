...
def load_glassmorphism_css():
    ...
    /* Hide white containers in sidebar and main content */
    ...
    /* Hide white boxes in chat results */
    .chat-bubble + div {
        display: none !important;
    }
    
    /* Force transparent backgrounds on all containers */
    .stMarkdown > div {
        background: transparent !important;
    }
    ...
    /* Hide any remaining white boxes */
...
def create_chat_bubble(query, answer, source_type, timestamp, tokens):
    ...
    return f"""
    <div class="chat-bubble" style="background: rgba(255, 255, 255, 0.1) !important; backdrop-filter: blur(12px) !important; border-radius: 14px !important; border: 1px solid rgba(255, 255, 255, 0.15) !important; padding: 0.75rem 1rem !important; margin: 0.5rem 0 !important; transition: all 0.3s ease !important;">
        <div style="color: #81c784 !important; font-weight: 500 !important; font-size: 0.95rem !important; margin-bottom: 0.5rem !important;">🔍 {query}</div>
        <div style="color: rgba(255, 255, 255, 0.9) !important; font-size: 0.9rem !important; line-height: 1.5 !important; margin-bottom: 0.75rem !important;">{answer}</div>
        {token_counter}
        <div style="color: rgba(255, 255, 255, 0.6); font-size: 0.75rem; margin-top: 0.5rem; background: transparent !important;">
            {icon} {source_type.upper()} | {timestamp.strftime('%H:%M:%S')}
        </div>
    </div>
    """
