"""
Glassmorphism UI Prototype with Collapsible Sidebar - FIXED VERSION
...
def load_glassmorphism_css():
    ...
    /* Hide any stray HTML elements and white boxes */
    ...
    /* Hide white backgrounds in chat bubbles */
    .chat-bubble .element-container {
        background: transparent !important;
    }
    
    /* Hide white containers */
    ...
    /* Hide toggle text and keep only icon */
    [data-testid="collapsedControl"] {
        background: rgba(100, 181, 246, 0.3) !important;
        border-radius: 12px !important;
...
def main():
    ...
    <div class="glass-header">
        ...
        <p>Glassmorphism UI Prototype with Collapsible Sidebar - FIXED</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        # Query Interface in proper glass container
        query_interface_html = f"""
        <div class="glass-container">
            <h3 style="color: #64b5f6; margin-bottom: 1rem; font-size: 1.1rem;">💬 Query Interface</h3>
        </div>
        """
        st.markdown(query_interface_html, unsafe_allow_html=True)
        ...
        if st.session_state.chat_history:
            results_html = """
            <div class="glass-container">
                <h3 style="color: #64b5f6; margin-bottom: 0.75rem; font-size: 1.1rem;">📝 Recent Results</h3>
            </div>
            """
    ...
    <div style="text-align: center; margin-top: 2rem; padding: 1rem; background: rgba(255, 255, 255, 0.05); border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1);">
        <div style="color: rgba(255, 255, 255, 0.6); font-size: 0.8rem;">🎨 Glassmorphism UI Prototype - FIXED VERSION | Use native sidebar toggle to collapse/expand</div>
    </div>
    """, unsafe_allow_html=True)
